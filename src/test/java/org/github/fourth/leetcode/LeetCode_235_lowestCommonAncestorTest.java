...
class LeetCode_235_lowestCommonAncestorTest {
    ...
    public void test01(TreeNode root, TreeNode p, TreeNode q, int expectedResult) {
        TreeNode actResult = leetCode235LowestCommonAncestor.lowestCommonAncestor(root, p, q);
    }

    public static Stream<Arguments> generateRightCase() {
        return Stream.of(
                arguments(
                        TreeNode.build(List.of(6, 2, 8, 0, 4, 7, 9, null, null, 3, 5)),
                        TreeNode.build(List.of(2, 0, 4, null, null, 3, 5)),
