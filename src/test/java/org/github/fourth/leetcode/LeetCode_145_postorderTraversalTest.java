...
class LeetCode_145_postorderTraversalTest {
    ...
    public void test01(TreeNode root, List<Integer> expectedResult) {
        List<Integer> actResult = leetCode145PostorderTraversal.postorderTraversal01(root);
...
//    @ParameterizedTest
    ...
    public void test02(TreeNode root, List<Integer> expectedResult) {
        List<Integer> actResult = leetCode145PostorderTraversal.postorderTraversal02(root);
        Assertions.assertArrayEquals(expectedResult.toArray(), actResult.toArray());
    }
//    @ParameterizedTest
    @MethodSource("generateRightCase")
    public void test03(TreeNode root, List<Integer> expectedResult) {
        List<Integer> actResult = leetCode145PostorderTraversal.postorderTraversal03(root);
        Assertions.assertArrayEquals(expectedResult.toArray(), actResult.toArray());
    }

    public static Stream<Arguments> generateRightCase() {
        return Stream.of(
                arguments(TreeNode.build(Arrays.asList(1, null, 2, null, null, 3)), Arrays.asList(3, 2, 1)),
