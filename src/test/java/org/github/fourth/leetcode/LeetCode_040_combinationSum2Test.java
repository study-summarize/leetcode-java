...
class LeetCode_040_combinationSum2Test {
    ...
    public void test01(int[] candidates, int target, List<List<Integer>> expectedResult) {
        List<List<Integer>> actResult = leetCode040CombinationSum2.combinationSum201(candidates, target);
        VerifyUtils.assertListInListEquals(expectedResult, actResult);
    }

    public static Stream<Arguments> generateRightCase() {
        return Stream.of(
                arguments(new int[]{10, 1, 2, 7, 6, 1, 5}, 8, List.of(List.of(1, 1, 6), List.of(1, 2, 5), List.of(1, 7), List.of(2, 6))),
