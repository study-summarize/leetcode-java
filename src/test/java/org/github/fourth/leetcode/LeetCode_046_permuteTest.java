...
class LeetCode_046_permuteTest {
    ...
    public void test01(int[] nums, List<List<Integer>> expectedResult) {
        List<List<Integer>> actResult = leetCode046Permute.permute(nums);
    }

    public static Stream<Arguments> generateRightCase() {
        return Stream.of(
                arguments(new int[]{1, 2, 2}, List.of(List.of(1, 2, 3), List.of(1, 3, 2), List.of(2, 1, 3), List.of(2, 3, 1), List.of(3, 1, 2), List.of(3, 2, 1))),
